...
public class DBCreator {
    ...
    public DBCreator(Connection conn) throws Exception {
        ...
        statement.executeUpdate("ALTER TABLE Client ALTER COLUMN idClient RESTART WITH 13;");
        statement.executeUpdate("ALTER TABLE Pet ALTER COLUMN idPet RESTART WITH 14;");
    }

    public void CSVtoDB(String fileName) throws Exception {
